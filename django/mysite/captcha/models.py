...
class Caltech256Image(models.Model):
    imgname = models.CharField(blank=False, max_length=32)
    category = models.CharField(blank=False, max_length=32)
    labeldate = models.DateTimeField(blank=False)
